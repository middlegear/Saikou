...
class MangaReadAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        // Source Selection
        val source = media.selected!!.source.let {
        ...
        binding.animeSource.setAdapter(
            ArrayAdapter(fragment.requireContext(), R.layout.item_dropdown, mangaReadSources.names)
        )
        ...
        if (media.manga?.chapters != null) {
            ...
            if (chapters.contains(continueEp)) {
                ...
                binding.animeSourceContinueText.text =
                    currActivity()!!.getString(R.string.continue_chapter) +
                            "${ep.number}${
